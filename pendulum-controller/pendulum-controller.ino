...
const float SWING_ANGLE = 90.0; // *** LÍNEA MODIFICADA: Ángulo de swing (puedes modificar este valor) ***
const unsigned long SWING_DELAY = 100; // *** LÍNEA MODIFICADA: Delay entre movimientos (1 segundo) ***
const float TARGET_ANGLE = 180.0; // *** LÍNEA MODIFICADA: Ángulo objetivo del encoder ***

// Stepper config
L6474_init_t stepper_config = {
20000, // Acceleration rate in pps^2. Range: (0..+inf)
20000, // Deceleration rate in pps^2. Range: (0..+inf)
3000, // Maximum speed in pps. Range: (30..10000]
3000, // Minimum speed in pps. Range: [30..10000)
